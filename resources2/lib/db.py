...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib.util import QuotePlus, Unquote
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib.comaddon import dialog, addon, VSlog, VSPath, isMatrix, xbmc
...
class cDb:
    ...
    if name == 'Master user':
        ...
        DB = GetCacheSubDir('Tsiplayer')+'matrix.db'
    else:
        from Plugins.Extensions.IPTVPlayer.tools.iptvtools import GetCacheSubDir
        DB = GetCacheSubDir('Tsiplayer')+'matrix.db'
