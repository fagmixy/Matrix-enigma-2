...
import re
import string
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib import xbmcvfs
import json

from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib.comaddon import addon, dialog, VSlog, VSPath, isMatrix, xbmc, xbmcgui
...
class cTMDb:
    ...
    def getToken(self):
        ...
        if (total > 0):
            ...
            if not xbmc.getCondVisibility('system.platform.android'):
                ...
                from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib import pyqrcode
    ...
    def _format(self, meta, name, media_type=""):
        ...
        if 'credits' in meta and meta['credits']:
            # Code from https://github.com/jurialmunkey/plugin.video.themoviedb.helper/blob/matrix/resources2/lib/tmdb/mapping.py
            cast_list = []
