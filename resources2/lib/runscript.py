...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib.comaddon import addon, dialog, VSlog, window, VSPath, xbmc
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib.util import urlEncode
    ...
    def main(self, env):
        ...
        if (env == 'resolveurl'):
            ...
            class XMLDialog(xbmcgui.WindowXMLDialog):
                ...
                ADDON = addon()
                data = None
                path = VSPath('special://home/addons/plugin.video.matrix/resources2/sites.json')
                def __init__(self, *args, **kwargs):
                    xbmcgui.WindowXMLDialog.__init__(self)
                    pass
                ...
                def onInit(self):
                    ...
                    for aPlugin in aPlugins:
                        ...
                        icon = "special://home/addons/plugin.video.matrix/resources2/art/sites/%s.png" % aPlugin[1]
