...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib.comaddon import addon, xbmc, isMatrix, VSlog, isNexus
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib.db import cDb
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib.util import cUtil, QuoteSafe
...
class cGuiElement:
    ...
    def __init__(self):
        ...
        self.__sRootArt = 'file:///usr/lib/enigma2/python/Plugins/Extensions/IPTVPlayer/tsiplayer/addons/resources2/art/'
        self.__sType = 'video'
        self.__sMeta = 0
        self.__sTrailer = ''
...
#        self.__sTitleWatched = sTitleWatched
    ...
    def getIcon(self):
        ...
        folder = 'file:///usr/lib/enigma2/python/Plugins/Extensions/IPTVPlayer/tsiplayer/addons/resources2/art'
