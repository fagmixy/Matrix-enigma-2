...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib.comaddon import addon, VSlog
...
class cRechercheHandler:
    ...
    def importPlugin(self, sName, sCat):
        ...
        try:
            plugin = __import__('Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.sites.%s' % sName, fromlist=[sName])
    ...
    def getAvailablePlugins(self):
        ...
        sFolder = "/usr/lib/enigma2/python/Plugins/Extensions/IPTVPlayer/tsiplayer/addons/resources2/sites"
