...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib.comaddon import addon, dialog, progress, VSlog, VSupdate, VSPath, isMatrix
...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib.util import cUtil, UnquotePlus
...
class cDownload:
    ...
    def getDownload(self):
        ...
        item.setArt({'icon':'special://home/addons/plugin.video.matrix/resources2/art/download.png'})
