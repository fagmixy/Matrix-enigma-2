...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib.handler.siteHandler import cSiteHandler
...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib.comaddon import addon, window, dialog, xbmc
...
class cHome:
    ...
    def showUpdate(self):
        try:
            from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib.about import cAbout
