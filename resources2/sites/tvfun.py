...
def load():
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showSeries', 'انمي', 'mslsl.png', oOutputParameterHandler)

    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('siteUrl', 'https://a.tvfun.me/ts,baramij-tarfihiya/')
    oGui.addDir(SITE_IDENTIFIER, 'showSeries', 'برامج ترفيهية', 'mslsl.png', oOutputParameterHandler)
