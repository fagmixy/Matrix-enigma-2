...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.resources2.lib.util import cUtil, Quote
import re
...
def showGenres():
    ...
    liste = []
    liste.append( ["نيتفليكس","https://arabseed.ws/category/netfilx/"] )   
    liste.append( ["افلام","/movies"] )  
    liste.append( ["الرئيسية","/main/"] )
